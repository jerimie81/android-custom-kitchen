...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.runner.set_adb_serial_provider(self._refresh_and_selected_adb_serial)
    ...
    def _refresh_and_selected_adb_serial(self) -> str:
        self._refresh_adb_devices()
        return self._selected_adb_serial()
